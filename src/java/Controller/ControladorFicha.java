...
public class ControladorFicha extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        {
             int CodFicha = Integer.parseInt(request.getParameter("txtcodigo")); 
             int CantidadAprendiz = Integer.parseInt(request.getParameter("txtcanti")); 
          
            f.setCodFicha(CodFicha);
           f.setCantidadAprendiz(CantidadAprendiz);
